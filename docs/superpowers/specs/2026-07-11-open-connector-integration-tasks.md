...
- [x] 3.5 `filters.rs`: allowlisted Exact/Unsupported translation (`FilterMapping`), literal-side normalization, scalar→JSON conversion; `Inexact` reserved for conservative mappings
